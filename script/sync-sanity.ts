...
export async function syncSanity() {
 ...
 const names:Record<string,string>={"field-note":"Field Notes",perspective:"Perspectives","squared-report":"Squared Reports","looking-glass":"Looking Glass","inside-hq":"Inside Bain Squared HQ"};
 const seen=new Set();
